          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:block">
              <div className="ml-10 flex items-baseline space-x-4">
                ...
                <Link to='/favourites' class="nav-link text-gray-700 hover:text-sa-green px-3 py-2 rounded-md text-sm font-medium">Saved Properties
                ...
                <Link to="/financing" className="nav-link bg-sa-green text-white px-3 py-2 rounded-md text-sm font-medium">Financing</Link>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-2xl mx-auto bg-gray-50 rounded-lg shadow-lg p-8">
            ...
            <button className="w-full mt-6 bg-sa-gold hover:bg-yellow-500 text-gray-900 font-bold py-3 px-4 rounded-md transition duration-300">
              Apply Now
            </button>
          </div>
        </div>
      ...
      <section className="py-16 bg-sa-blue text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <button className="bg-sa-gold hover:bg-yellow-500 text-gray-900 font-bold py-3 px-8 rounded-md transition duration-300">
              Apply for Financing
            </button>
