                    ...
                    <div class="flex justify-between items-center h-16">
                        ...
                        <div class="hidden md:block">
                            <div class="ml-10 flex items-baseline space-x-4">
                                <Link to="/home" class="nnav-link text-gray-700 hover:text-sa-green px-3 py-2 rounded-md text-sm font-medium">Find Homes</Link>
                                ...
                                <Link to='/financing' class="nav-link bg-sa-green text-white px-3 py-2 rounded-md text-sm font-medium">Financing</Link>
