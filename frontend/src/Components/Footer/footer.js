        ...
        <footer class="bg-gray-900 text-white py-12">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                    <div>
                        <h3 class="text-2xl font-bold text-sa-green mb-4">Rentekasi</h3>
                        <p class="text-gray-400 mb-4">Transforming township rentals across South Africa with trust, technology, and transparency.</p>
                        <div class="flex space-x-4">
                            ...
                            <a 
                                href="https://www.linkedin.com/company/rentekasi" 
                                target="_blank" 
                                rel="noopener noreferrer" 
                                className="text-gray-400 hover:text-white"
                                aria-label="Visit RentEkasi on LinkedIn"
                            >
                ...
                <div class="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
                    <p>&copy; 2024 Rentekasi. All rights reserved. Transforming South African township rentals.</p>
                </div>
            </div>
        </footer>
    )
